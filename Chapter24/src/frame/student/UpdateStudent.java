...
public class UpdateStudent extends JFrame implements ActionListener {
	...
	JLabel head_label = new JLabel("学生基本信息", JLabel.CENTER);		// 使用文本创建一个“头部”标签对象
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(source == update_button) {
			...
			try {
				...
				if(rs.next()) {		// 判断结果是否存在
					sql = "UPDATE student set name='"+ name + "', sclass='"
							+ sclass + "', sex=''" + sex + "', academy=''" + academy + "', birthday=''" + birthday + "'";		// 修改一组数据
