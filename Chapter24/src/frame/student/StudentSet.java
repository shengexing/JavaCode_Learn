...
public class StudentSet extends JFrame implements ActionListener {
	...
	public StudentSet() {
		...
		// 设置班级标签及其文本框的相关属性
		class_label.setBounds(100, 280, 60, 20);
		this.add(class_label);
		class_field.setBounds(200, 280, 80, 20);
