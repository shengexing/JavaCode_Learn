...
public class UpdateGrade extends JFrame implements ActionListener {
	...
	JLabel head_label = new JLabel("修改学生成绩信息", JLabel.CENTER);		// 使用文本创建一个“头部”标签对象
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(source == update_button) {
			...
			try {
				...
				if(rs.next()) {		// 判断结果是否存在
					sql = "UPDATE grade set chinese=''" + chinese + "', math=''" + math + "' WHERE number=" + number;		// 修改一组数据
